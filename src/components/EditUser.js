...
class EditUser extends Component {
  ...
  componentDidMount() {
    axios.get(`https://halzaabhamad.herokuapp.com/api/users/${this.props.match.params.id}`)
    .then(res => {
        this.setState({ 
            name: res.data.name,
  ...
  updateUser(event) {
    ...
    axios.post(`https://halzaabhamad.herokuapp.com/api/users/update/${this.props.match.params.id}`, userUpdate)
    .then(res => { 
        console.log(res);
